...
function Footer() {
  return (
    <div  className='container-fluid w-auto mt-4 bg-black shadow '>
    <div className="footer-content d-flex justify-content-between row ">
      ...
      <div className="contact d-flex flex-column col-lg-3 mt-3">
        <h4 className='text-light text-center' style={{pointerEvents:'none'}}>Contact Us</h4>
                 
        <div style={{ color: 'black' }} className="icons mt-3 d-flex justify-content-around ">
    ...
    <p style={{fontSize:'14px',pointerEvents:'none'}} className='text-center mt-4 text-success '>Copyright &copy;2024 Relator App . Build with React.</p>
  </div>
  )
}
